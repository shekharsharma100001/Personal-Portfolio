...
if page == "Home":
    ...
    with st.container(border = True):
        ...
        img1.image(r'images/GenAI.jpg',use_container_width=True)
    with st.container(border = True):
        ...
        img2.image(r'images/AI.jpg',use_container_width=True)
    with st.container(border = True):
        ...
        img3.image(r'images/NLP.jpg',use_container_width=True)
    with st.container(border = True):
        ...
        img4.image(r'images/CV.jpg',use_container_width=True)
    with st.container(border = True):
        ...
        img5.image(r'images/DL.jpg',use_container_width=True)
    with st.container(border = True):
        ...
        img6.image(r'images/DS.jpg',use_container_width=True)
    with st.container(border = True):
